...
type RocketType ={
  rocket_id: string, rocket_name: string, rocket_type: string
}
type LinkType={
  mission_patch: string, mission_patch_small: string, reddit_campaign: string, reddit_launch: string, reddit_recovery: string
}
type LaunchSiteType ={
  site_id: string, site_name: string, site_name_long:string
}
type LaunchType ={
  crew: null |any
details: string
